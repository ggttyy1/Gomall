...
var (
	userSeviceServiceInfo                = NewServiceInfo()
	userSeviceServiceInfoForClient       = NewServiceInfoForClient()
	userSeviceServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return userSeviceServiceInfo
}

// for client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return userSeviceServiceInfoForStreamClient
}

// for stream client
func serviceInfoForClient() *kitex.ServiceInfo {
	return userSeviceServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	...
	handlerType := (*user.UserSevice)(nil)
...
func registerHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.UserSevice).Register(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *RegisterArgs:
		success, err := handler.(user.UserSevice).Register(ctx, s.Req)
		if err != nil {
			return err
		}
...
func loginHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.UserSevice).Login(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *LoginArgs:
		success, err := handler.(user.UserSevice).Login(ctx, s.Req)
		if err != nil {
			return err
		}
