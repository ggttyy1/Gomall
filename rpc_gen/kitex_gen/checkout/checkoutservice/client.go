...
func (p *kCheckoutServiceClient) CheckoutProduct(ctx context.Context, Req *checkout.CheckoutProductReq, callOptions ...callopt.Option) (r *checkout.CheckoutProductResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CheckoutProduct(ctx, Req)
}
