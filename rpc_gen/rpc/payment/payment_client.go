...
type RPCClient interface {
	...
	Service() string
	Charge(ctx context.Context, Req *payment.PaymentServiceReq, callOptions ...callopt.Option) (r *payment.PaymentServiceResp, err error)
}
...
func (c *clientImpl) Charge(ctx context.Context, Req *payment.PaymentServiceReq, callOptions ...callopt.Option) (r *payment.PaymentServiceResp, err error) {
