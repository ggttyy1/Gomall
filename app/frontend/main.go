...
var (
	...
	RegistryAddress    = conf.GetConf().Hertz.RegistryAddress
)
...
func main() {
	...
	h.GET("/sign-up", func(c context.Context, ctx *app.RequestContext) {
		ctx.HTML(consts.StatusOK, "sign-up", utils.H{"Title": "Sigh up"})
	})
	h.GET("/person-info", func(c context.Context, ctx *app.RequestContext) {
		ctx.HTML(consts.StatusOK, "person-info", bizutils.WarpResponse(c, ctx, utils.H{
			"Title": "Person Info",
	...
	h.GET("/about", func(c context.Context, ctx *app.RequestContext) {
		ctx.HTML(consts.StatusOK, "about", bizutils.WarpResponse(c, ctx, utils.H{"Title": "About"}))
	}, middleware.Auth())
	h.GET("/UpProducts", func(c context.Context, ctx *app.RequestContext) {
		ctx.HTML(consts.StatusOK, "up-products", bizutils.WarpResponse(c, ctx, utils.H{"Title": "Up Products"}))
	}, middleware.Auth())
	h.Spin()
}
