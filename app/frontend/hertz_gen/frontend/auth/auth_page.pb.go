...
var file_auth_page_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0d, 0x66, 0x72, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x64, 0x2e, 0x68, 0x6f, 0x6d, 0x65,
	...
	0x72, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x64, 0x2e, 0x68, 0x6f, 0x6d, 0x65, 0x2e, 0x4c, 0x6f, 0x67,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x64, 0x2e, 0x68, 0x6f, 0x6d, 0x65, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73,
...
var file_auth_page_proto_goTypes = []interface{}{
	(*LoginReq)(nil),     // 0: frontend.home.LoginReq
	(*RegisterReq)(nil),  // 1: frontend.home.RegisterReq
	(*common.Empty)(nil), // 2: frontend.common.Empty
}
var file_auth_page_proto_depIdxs = []int32{
	0, // 0: frontend.home.AuthService.login:input_type -> frontend.home.LoginReq
	1, // 1: frontend.home.AuthService.register:input_type -> frontend.home.RegisterReq
	2, // 2: frontend.home.AuthService.logout:input_type -> frontend.common.Empty
	2, // 3: frontend.home.AuthService.login:output_type -> frontend.common.Empty
	2, // 4: frontend.home.AuthService.register:output_type -> frontend.common.Empty
	2, // 5: frontend.home.AuthService.logout:output_type -> frontend.common.Empty
