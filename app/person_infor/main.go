...
import (
	...
	"github.com/cloudwego/biz-demo/gomall/app/person_infor/biz/dal"
	"github.com/cloudwego/biz-demo/gomall/app/person_infor/conf"
...
func main() {
	...
	svr := personinfor.NewServer(new(PersonInforImpl), opts...)
