...
type CheckoutProductService struct {
	ctx context.Context
} // NewCheckoutProductService new CheckoutProductService
func NewCheckoutProductService(ctx context.Context) *CheckoutProductService {
	return &CheckoutProductService{ctx: ctx}
}

// Run create note info
func (s *CheckoutProductService) Run(req *checkout.CheckoutProductReq) (resp *checkout.CheckoutProductResp, err error) {
	// Finish your business logic.
	// Finish your business logic.
	cartResult, err := rpc.CartClient.GetCartByProduct(s.ctx, &cart.GetCartByProductReq{UserId: req.UserId, ProductIds: req.ProductIds})
	if err != nil {
		return nil, err
	}
	...
	_, err = rpc.CartClient.RemoveCartByProduct(s.ctx, &cart.RemoveCartByProductReq{UserId: req.UserId, ProductIds: req.ProductIds})
	if err != nil {
		return nil, err
	}
	...
	return &checkout.CheckoutProductResp{OrderId: OrdResp.OrderId, TransactionId: PayRes.TransactionId}, nil
